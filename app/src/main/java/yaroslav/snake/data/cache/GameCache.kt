package yaroslav.snake.data.cache
...
import yaroslav.snake.data.model.HighScore
import yaroslav.snake.domain.base.DATASTORE_KEY_HIGH_SCORES
import yaroslav.snake.domain.base.DATASTORE_KEY_PLAYER_NAME
import yaroslav.snake.domain.base.DATASTORE_NAME
...
class GameCache(private val context: Context) {
    ...
    val getPlayerName: Flow<String> = context.dataStore.data.map { preferences ->
        preferences[PLAYER_NAME_KEY] ?: "Игрок 1"
    }
